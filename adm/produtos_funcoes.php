    ...
    <div id="background">
        ...
        <div id="buttons">
            ...
            <a href="cadastrar_produtos.php">
                <button id="button_list_prod" class="btn btn-dark btn2">CADASTRAR PRODUTOS</button>
            </a>

            <a href="listar_produtos.php">
                <button id="button_insert_prod" class="btn btn-dark btn2">LISTAR PRODUTOS</button>
            </a>
